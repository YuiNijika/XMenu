...
export function TeleportPage({ report }: PageProps) {
  ...
  return (
    <div className="flex flex-col gap-5">
      <Tabs defaultValue="teleport" className="w-full">
        <TabsList className="mb-1">
          <TabsTrigger value="teleport">{t('tab.teleport')}</TabsTrigger>
          <TabsTrigger value="locations">{t('teleport.locations')}</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="locations">
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('teleport.listHint')}</CardDescription>
            </CardHeader>
            <CardContent>
              <DataBrowser
